...
export const toolDefinitions: ToolDefinitionSchema[] = [
  {
    ...
    inputSchema: {
      ...
      outputSchema: {
        ...
        items: {
          // Descreve cada objeto "curso" no array
          type: "object",
          properties: {
            id: {
              type: "integer",
            ...
            lang: {
              ...
              description:
                'The language code for the course (e.g., "pt", "en").',
            },
  ...
  },
  {
    ...
    outputSchema: {
      ...
      properties: {
        id: {
          type: "integer",
          description: "The unique ID of this module within the course.",
        },
        url: {
          type: "string",
          format: "url",
        ...
        instance: {
          type: "integer",
          description:
            'The instance ID of this specific module type (e.g., the ID in the "assign" table if modname is "assign").',
        },
        modname: {
          type: "string",
          description:
        ...
        contents: {
          type: "array",
          description:
            'Associated files or content parts. For "resource" modules, this contains the file details. For "page" modules, it might contain HTML content if structured that way.',
          items: {
            type: "object",
            properties: {
              type: {
              ...
              fileurl: {
                ...
                format: "url",
                description:
                  "Direct URL to download/access the file. Use this with get_resource_file_content or get_page_module_content.",
              },
              mimetype: {
                type: "string",
                description:
        ...
        intro: {
          type: "string",
          description:
            'Introduction or description HTML for the activity (common for "assign", "quiz", etc.). May contain the main content for some "page" modules.',
        },
        description: {
          type: "string",
          description:
            'Description HTML for the activity (alternative to "intro" in some Moodle versions/modules).',
        },
      },
