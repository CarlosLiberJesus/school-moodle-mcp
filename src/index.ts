...
setupFileLogger(projectRootLogsDir, { // Passar o diretório onde os logs devem ser criados
    logLevel: process.env.LOG_LEVEL as any || 'debug', // Usar variável de ambiente se definida
